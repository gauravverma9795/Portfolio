...
function Card() {
  return (
    ...
    <h2 className='text-green-600 text-lg'>About Me</h2> 
      <h5>Hey there! I'm Gaurav Verma, a Final Year Electronics and Communication Engineering (ECE) student at the Institute of Engineering and Technology, Lucknow. I'm passionate about Full stack web development and currently exploring the MERN stack (MongoDB, Express.js, React, and Node.js).</h5>
