  ...
  return (
    ...
    animate={{ opacity: 1, transition: { duration: 0.5 } }} className=''>
      ...
      <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          ...
          <div className='flex flex-col  gap-y-5'>
            ...
            <h2 className='px-3 font-extrabold text-lg text-amber-100' >4 ⭐ coder in (Codechef) Highest Rating 1805.</h2>
            </div>
        
          <div className='flex flex-row justify-center items-center gap-x-10'>
          
          <a className="underline italic  hover:text-designColor  duration-300 visited:text-blue-600" href="https://www.codechef.com/users/gauravverma979" target="_blank" rel="noopener noreferrer"  >CodeChef</a>
    ...
    <div className="w-full  lgl:w-1/2 h-1/3 group flex   my-10 ">
      ...
      <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          ...
          <div className='flex flex-col  gap-y-5'>
            <div  className='flex flex-row justify-center items-center'>
            <h2 className='px-3 font-extrabold text-lg text-amber-100' >PUPIL in CodeForces Highest Rating 1220.</h2>
            </div>
        
          <div className='flex flex-row justify-center items-center gap-x-10'>
          
          <a className="underline italic  hover:text-designColor  duration-300 visited:text-blue-600" href="https://codeforces.com/profile/gauravverma9795" target="_blank" rel="noopener noreferrer"  >CodeForces</a>
